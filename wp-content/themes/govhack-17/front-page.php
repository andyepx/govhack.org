...
get_header(); ?>
	...
	<section id="primary">
            ...
            <div class="wrapper">
                ...
                <div id="home-hero-slider" class="home-hero-slider">
                    <div>
                        ...
                        <?php else: ?>
                        <h1 id="gh-defined">
                            <dfn class="govhack tooltip-now" title="An event with a history that can be traced back to 2009.">GovHack</dfn> 
                            is an 
                            <dfn class="open-data tooltip-now" title="Data sets that governments (federal, state) have made available to the public.">open data</dfn> 
                            <dfn class="hackathon tooltip-now" title="A spontaneous, creative event where members form teams to create solutions to problems.">hackathon</dfn> 
                            held across 
                            <dfn class="australia tooltip-defer" title="<?php echo $au_tooltip ?>">Australia</dfn> 
                            and 
                            <dfn class="new-zealand tooltip-defer" title="<?php echo $nz_tooltip ?>">New Zealand</dfn> 
                        </h1>
                        <?php endif; ?>
                    </div>
                ...
                for ( $i = 1; $i <= 2; $i++ ): 
                    ...
                    if ( $label && $link ): ?>
                        ...
                        <?php else: ?>
                        <a class="button-minimal" href="<?php echo esc_url( $link ) ?>"><?php echo do_shortcode( $label ) ?></a> 
                        <?php endif; ?> 
                <?php endif; endfor; ?>
                </div>
            </div><!-- .wrapper -->
        ...
        <!-- <div class="content-area content-area-gray gh-registration-quicklinks-wrapper full-width">
        ...
        <div class="content-area full-width">
            <div class="gh-sponsors wrapper">
                <h2 class="gh-sponsors-header">
                    GovHack 2016 National Sponsors
                    <?php if ( isset($sponsor_logos_page_link) ): ?>
                    <small class="inline-muted-link"> | <a href="<?php echo $sponsor_logos_page_link ?>">See all national and state sponsors</a></small>
                    <?php endif; ?>
                </h2> 
        ...
        <?php if ( get_theme_mod('gh_tile_show_blurb', 0) ): ?>
        <div class="content-area content-area-gray full-width home-about">
            <div class="wrapper">
                <?php gh_row_open() ?>
                    <?php gh_col_open(1, 2) ?>
                        <?php if ( get_theme_mod('gh_blurb_title') ): ?>
                        <h3><?php echo get_theme_mod('gh_blurb_title') ?></h3>
                        <?php endif; ?>
                        <?php if ( get_theme_mod('gh_blurb_content') ): ?>
                        <p><?php echo wpautop( get_theme_mod('gh_blurb_content') ) ?></p>
                        <?php endif; ?>
                        <p><a class="button" href="/about-us/the-story/">The history of GovHack</a></p>
                    </div>
                    <?php gh_col_open(1, 2) ?>
                        <div class="video-wrapper bottom">
                            <!-- <div class="video-callout bottom">Our 2015 Red Carpet Awards @ the Powerhouse Museum!</div> -->
                            <!-- <iframe width="100%" height="300" src="https://www.youtube.com/embed/G6r4vL-T5Q0" frameborder="0" allowfullscreen></iframe> -->
                            <div class="video-callout bottom" style="bottom: 40px;"><?php echo get_theme_mod('gh_blurb_video_caption' , 'Check out this video!') ?></div>
                            <iframe width="100%" height="300" src="<?php echo get_theme_mod('gh_blurb_video_embed_url' , 'https://www.youtube.com/embed/qoNZqNivgig') ?>" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                <?php gh_row_close() ?>
            </div>
        ...
        <div class="content-area full-width">
            <div class="gh-tiles wrapper">
                <div class="gh-home-tile-header">
                    <div class="gh-home-social-media">
                        ...
                        <a href="<?php echo esc_url( $gh_twitter_url ) ?>"><span class="fa fa-twitter-square fa-2x"></span></a>
                        <?php endif; // gh_social_twitter ?>
                        <?php if ( $gh_facebook_url = get_theme_mod('gh_social_facebook', false) ): ?>
                        <a href="<?php echo esc_url( $gh_facebook_url ) ?>"><span class="fa fa-facebook-square fa-2x"></span></a>
            ...
            <div class="wrapper">
                ...
                <div class="gh-lastyear-notice">
                    ...
                    You might find it in <a href="http://archive.govhack.org" target="_blank">last year's website</a> 
                </div>
                <?php endif; ?>
            </div>
        </div>
