...
//==========================================
// Element Shortcodes
// For little things like buttons, inline images, etc
// @AY
//==========================================
...
function gh_sc_button($opts, $content = ''){
    ...
    $button_html = '<a class="' . esc_attr(implode(' ', $classNames)) .'" href="'. esc_url($args['href']) .'" target="'.$args['target'].'">';
    $button_html .= $content;
