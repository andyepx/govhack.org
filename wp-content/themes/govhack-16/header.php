...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header header-with-background" style="background-image: url('<?php header_image(); ?>');">
    <?php else: ?>
    ...
    <?php endif; ?>
        ...
        <div class="wrapper gh-headerdevice-container">
            <a class="gh-headerdevice gh-headerdevice-1 blue pink dual-color" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                ...
                <?php if ( get_header_image() ) : ?>
                    ...
                    <div class="site-title">
                        <img src="<?= get_stylesheet_directory_uri() . '/img/logo.png' ?>" alt="<?php bloginfo( 'name' ); ?>">
                    </div>
                    <?php else: ?>
